...
const DICT = {
  ru: {
    ...
    'auth.passwordLogin': 'Войти по паролю',
    'auth.loginOrUsername': 'Логин или @юзернейм',
    'auth.qrLogin': 'Вход по QR-коду',
    'auth.qrScanTitle': 'Сканируйте QR-код',
    'auth.qrScanHint': 'Откройте Onda на другом устройстве, зайдите в Настройки → Устройства и отсканируйте этот код.',
    'auth.qrGenerating': 'Генерация…',
    'auth.qrFailed': 'Не удалось создать QR',
    'auth.qrExpired': 'QR-код истёк',
    'auth.qrConfirmed': '✓ Подтверждено',
    'auth.qrRefresh': 'Обновить QR',
    'auth.qrWaiting': 'Ожидание сканирования…',
  ...
  en: {
    ...
    'auth.qrScanTitle': 'Scan QR code',
    'auth.qrScanHint': 'Open Onda on another device, go to Settings → Devices and scan this code.',
    'auth.qrGenerating': 'Generating…',
    'auth.qrFailed': 'Failed to generate QR',
    'auth.qrExpired': 'QR expired',
    'auth.qrConfirmed': '✓ Confirmed',
    'auth.qrRefresh': 'Refresh QR',
