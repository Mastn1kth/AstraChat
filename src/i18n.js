...
const DICT = {
  ru: {
    ...
    'auth.next': 'Далее',
    'auth.testLogin': 'Тестовый вход',
    'auth.testLogin2': 'Тестовый вход 2',
    'auth.name': 'Имя',
    ...
    'auth.foot': 'Сквозное шифрование. Ваши сообщения видите только вы.',
  ...
  en: {
    ...
    'auth.next': 'Next',
    'auth.testLogin': 'Test login',
    'auth.testLogin2': 'Test login 2',
    'auth.name': 'Name',
    ...
    'auth.foot': 'End-to-end encrypted. Only you can read your messages.',
