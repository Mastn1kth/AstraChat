...
echo [1/2] Stopping Onda backend...
...
echo [2/2] Stopping Cloudflare Tunnel gory-staff-local...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
...
echo.
echo Stopped. The phone app will not connect until start-onda-stack.bat is run again.
exit /b 0
