...
Цель:
Создать масштабируемый мессенджер с личными чатами, группами, каналами, стикерами, реакциями, медиа, звонками, ботами, настройками, темами, уведомлениями, поиском, профилями, безопасностью и архитектурой, готовой к backend, WebSocket, базе данных, файлам и production-развитию.
...
- индикаторы pinned, muted, archived, verified, premium, bot;
...
- права бота в группе;
- web app / mini app button как UI;
- bot messages;
- bot callbacks как mock;
- payments через бота как UI-сценарий;
- админская настройка bot permissions.

Mini Apps:
- открытие mini app внутри мессенджера;
- full-screen mini app view;
- кнопка назад;
- передача данных пользователя как mock;
- permissions для mini app;
- geolocation permission как UI;
- закрытие mini app;
- mini app в боте;
- mini app в меню.
