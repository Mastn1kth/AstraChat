...
import { createSession, destroySession, getSessionTokenHash, getSessionUser, requireAuth } from './auth.js'
import {
  decryptBuffer,
  decryptMessage,
  encryptBuffer,
...
// Extracted modules
import { socketsByUserId, state, addSocket, removeSocket, deliverToLocalUser, deliverLocalBroadcast, sendToUser, sendToChat, sendToChatExcept, sendToCall, broadcast } from './socket-manager.js'
import {
  isDatabaseTrue, parseJsonObject, isFutureTimestamp, parseBooleanFormValue,
  normalizeSearchText, normalizeSearchQuery, normalizeFolderTitle,
  formatByteSize, initials, parseOptionalInteger, summarizeUserAgent, parseByteRange,
  normalizePhone, hashPhoneCode, publicPhoneCodePayload,
  parsePublicKey, stringifyPublicKey,
  publicUser, publicChatSettings, publicSession, publicSecurityEvent, publicCallRow, publicWallMessage,
  sealTotpSecret, openTotpSecret,
  createSecurityEvent, loadOwnTotpState,
  isChatMember, requireChatMemberRow, isBannedFromChat, hasBlockBetween,
  privateChatCounterpart, requireUnblockedPrivateChat,
  sharedUserIdsForKeyWarnings, ensureChatSettings, validateMemberChatIds,
  appendAdminLog, getReactionCounts, getCallParticipants,
  ROLE_PERMISSIONS, publicChatPermissions, hasPermission, requirePermission, assertCanSendToChat,
  INDEFINITE_MUTE_UNTIL, MESSAGE_SELECT_COLUMNS, visibleMessageFilter,
  publicMessagesFromRows,
  serverMediaTransformMaxBytes, MIME_PATTERN, validateClientMediaMetadata,
  encryptUploadedFileToStorage, createMediaDecipher, ByteRangeTransform, streamDecryptedMedia,
} from './server-helpers.js'
import { sendLoginCodePush, sendOfflineMessagePushes } from './push-service.js'
import { publishDueScheduledMessages, publishScheduledMessage } from './scheduled.js'
import { authLimiter, wallLimiter, messageLimiter, uploadLimiter, apiLimiter, storiesLimiter } from './limiters.js'
// Route modules
