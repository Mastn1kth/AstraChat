...
AstraChat — современный мессенджер с акцентом на приватность, построенный как полноценное приложение. Полный стек: React 19 + Vite фронтенд, Express 5 бэкенд, WebSocket, шифрование на сервере (AES-256-GCM) и клиентские зашифрованные конверты (RSA-OAEP), WebRTC звонки, группы, каналы, медиа и чистый UI. Это не аудированный E2EE-протокол — подробности в [docs/security.md](docs/security.md).
...
- Перевод сообщений (клиентский, не отправляет расшифрованный текст на бэкенд Onda);
